...
extern "C" JNIEXPORT
void JNICALL Java_com_sdengine_unittest_1graphicsapi_MainActivity_InitializeApplication(
        JNIEnv *env,
        jobject obj,
        jobject j_asset_mgr)
{
...
extern "C" JNIEXPORT
void JNICALL Java_com_sdengine_unittest_1graphicsapi_MainActivity_ChangeSurface(
        JNIEnv *env,
        jobject obj,
        jobject surface,
        jint format,
...
extern "C" JNIEXPORT
void JNICALL Java_com_sdengine_unittest_1graphicsapi_MainActivity_Pause(
        JNIEnv *env,
        jobject obj)
{
    if (g_app != nullptr) {
