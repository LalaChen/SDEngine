...
protected:
    VkImage m_red_error_img;
    VkDeviceMemory m_red_error_img_mem;
protected:
    VkDescriptorSetLayout m_VK_present_gp_set_layout;
    VkDescriptorPool m_VK_present_gp_set_pool;
    VkSampler m_VK_screen_cb_sampler;
    VkShaderModule m_VK_screen_vert_shader;
    VkShaderModule m_VK_screen_frag_shader;
    VkPipelineLayout m_VK_screen_pipeline_layout;
    VkPipeline m_VK_screen_pipeline;
    VkDescriptorSet m_VK_screen_desc_set;
    VkImageView m_VK_target_cb_image_view;
protected:
    VkBuffer m_VK_screen_ver_buffer;
    VkDeviceMemory m_VK_screen_ver_buf_memory;
    VkBuffer m_VK_screen_ver_tex_buffer;
    VkDeviceMemory m_VK_screen_ver_tex_buf_memory;
    VkBuffer m_VK_screen_indices_buffer;
    VkDeviceMemory m_VK_screen_ibuf_memory;
};