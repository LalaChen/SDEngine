...
public:
    ...
    VkImage GetColorBuffer() override { return m_VK_color_buffers[0]; }
protected:
...
protected:
//for camera
    VkImage m_VK_color_buffers[COLOR_AND_DEPTH_BUFFER_SIZE];
    VkDeviceMemory m_VK_color_buffer_memories[COLOR_AND_DEPTH_BUFFER_SIZE];
    VkImageView m_VK_color_buffer_image_views[COLOR_AND_DEPTH_BUFFER_SIZE];
    VkImage m_VK_depth_buffers[COLOR_AND_DEPTH_BUFFER_SIZE];
    VkDeviceMemory m_VK_depth_buffer_memories[COLOR_AND_DEPTH_BUFFER_SIZE];
