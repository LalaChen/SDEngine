...
void Sample2_DrawScene::CreateRenderPassAndFramebuffer()
{
    ...
    m_render_flow_sref = new RenderFlow("ForwardPathFlow");
    m_render_flow_sref.GetRef().RegisterRenderPass(rp_wref);
    m_render_flow_sref.GetRef().AllocateFrameBuffer();
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_color_buffer_sref, 0);
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_depth_buffer_sref, 1);
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_color_buffer_sref, 2);
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_depth_buffer_sref, 3);
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_color_buffer_sref, 4);
    m_render_flow_sref.GetRef().RegisterBufferToFrameBuffer(m_depth_buffer_sref, 5);
